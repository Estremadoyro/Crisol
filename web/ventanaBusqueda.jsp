...
<jsp:useBean id="listaBusqueda" class="java.util.ArrayList" scope="session" />  
<!DOCTYPE html>
<html>
    <head>
            ...
            <section class="jumbotron text-center">
                <div class="container">
                    ...
                    <form action="s05" class="form-inline justify-content-center md-form mr-auto mb-4">
                        <input class="form-control mr-sm-2 rounded border-info" type="text" name="tituloBusqueda" placeholder="Titulo" aria-label="Search">
                ...
                <div class="container">
                     <div class="row row-sm-6">
                        <% for (int i = 0; i < listaBusqueda.size(); i++) {
                                Libro l = (Libro) listaBusqueda.get(i);
                        %> 
                        <div class="col-md-4">
                            <div class="card mb-4 py-3 shadow-l">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a class="btn btn-sm btn-info" href="ventanaActualizar.jsp?codigo=<%= l.getCodigo()%>&titulo=<%= l.getTitulo()%>&autor=<%= l.getAutor()%>&precio=<%= l.getPrecio()%>" >Editar</a>    
