...
public class Servlet04 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int codigoAct = Integer.parseInt(request.getParameter("codigoAct"));
        String tituloAct = request.getParameter("tituloAct");
        String autorAct = request.getParameter("autorAct");
        double precioAct = Double.parseDouble(request.getParameter("precioAct"));
        String imagenURL =request.getParameter("imagenURL");
        
        
        HttpSession ses = request.getSession(true);
        LibroIF dao = new LibroMongo();
        dao.updateLibro(codigoAct,tituloAct,autorAct,precioAct,imagenURL);
